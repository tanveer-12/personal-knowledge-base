...
<!-- PLACEHOLDER: Add screenshot of minimalist theme dashboard here -->
![Minimalist Theme](docs/screenshots/minimalist-theme.png)

<!-- PLACEHOLDER: Add screenshot of neon theme dashboard here -->
![Neon Theme](docs/screenshots/neon-theme.png)

<!-- PLACEHOLDER: Add demo GIF here (search in action) -->
![Demo](docs/demo.gif)
